...
<head>
  ...
  <title>Hotel Hill View - Room Details</title>
</head>
      ...
      <div class="col-lg-5 col-md-12 px-4">
        <div class="card mb-4 border-0 rounded-3 shadow-sm">
          <div class="card-body">
            <?php
            echo <<<price
            <h4 class="mb-4">रु. $room_data[price] Per Night</h6>
            price;
          ...
          area;
            ...
            if (!$setting_r['shutdown'] && isset($_SESSION['login']) && $_SESSION['login'] == true) {
              echo <<<book
              <button href="#" onclick='redirectToBooking($room_data[id])' class="btn  w-100 text-white custom-bg shadow-none mb-2">Book Now</button>
            book;
            }
