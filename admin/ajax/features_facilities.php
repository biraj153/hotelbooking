...
if (isset($_POST['get_features'])) {
    ...
    while ($row = mysqli_fetch_assoc($res)) {
        echo <<<data
            ...
            <td>$row[name]</td>
            <td>
            <button type="button" onclick="rem_feature($row[id]);" class="btn btn-danger btn-sm shadow-none"><i class="bi bi-trash"></i> Delete</button>
            </td>
            </tr>
        data;
        $i++;
...
if (isset($_POST['get_facilities'])) {
    ...
    while ($row = mysqli_fetch_assoc($res)) {
        echo <<<data
            ...
            <td>
            <button type="button" onclick="rem_facility($row[id]);" class="btn btn-danger btn-sm shadow-none"><i class="bi bi-trash"></i> Delete</button>
            </td>
            </tr>
        data;
        $i++;
