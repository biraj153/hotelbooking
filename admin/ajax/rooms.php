...
if (isset($_POST['get_all_rooms'])) {
    ...
    while ($row = mysqli_fetch_assoc($res)) {
        ...
        <td>$status</td>
        <td>
          <button type='button' class='btn btn-primary shadow-none btn-sm' onclick='edit_details($row[id])' data-bs-toggle='modal' data-bs-target='#edit-room'>
             <i class='bi bi-pencil-square'></i>
          </button>
          <button type='button' class='btn btn-info shadow-none btn-sm' onclick=\"room_images($row[id], '$row[name]')\" data-bs-toggle='modal' data-bs-target='#room-images'>
          <i class='bi bi-images'></i>
          </button>
          <button type='button' class='btn btn-danger shadow-none btn-sm' onclick='remove_room($row[id])' data-bs-toggle='modal''>
