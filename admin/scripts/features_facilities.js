...
function add_feature() {
  ...
  xhr.onload = function () {
    ...
    if (this.responseText == 1) {
      ...
      alert("error", "Error Uploading Feature");
    }
  };
...
function rem_feature(val) {
  ...
  xhr.onload = function () {
    if (this.responseText == 1) {
      ...
      alert("error", "Error Removing Feature");
    }
  };
...
function add_facility() {
  ...
  xhr.onload = function () {
    ...
    if (this.responseText == "inv_img") {
      ...
      alert("error", "Image size needs to me less than 2MB");
...
function rem_facility(val) {
  ...
  xhr.onload = function () {
    ...
    if (this.responseText == 1) {
      ...
      alert("error", "Error Removing Facility");
    }
  };
